...
public class DotsTerrainColliderConversionSystem : GameObjectConversionSystem
{
    ...
    private static BlobAssetReference<Collider> CreateTerrainCollider( TerrainData terrainData,
        TerrainCollider.CollisionMethod collisionMethod, CollisionFilter filter )
    {
        ...
        var collider = TerrainCollider.Create(colliderHeights, size, scale, collisionMethod, filter);
